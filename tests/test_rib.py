...
import pytest
from src.system import Route, RouteStatus, SourceCode, RIBRouteEntry, RIB
...
def test_rib(default_route: Route):
    rib = RIB()
    rib_route_entry = RIBRouteEntry(default_route.prefix, default_route.next_hop, SourceCode.BASIC, 1, 1, RouteStatus.UNKNOWN)
    ...
    rib_route_entry2 = RIBRouteEntry(default_route.prefix, next_hop, SourceCode.BASIC, 1, 1, RouteStatus.UNKNOWN)
